...
#define USBD_MANUFACTURER_STRING     "sa"
#define USBD_PID_HS     10203
#define USBD_PRODUCT_STRING_HS     "USB Keyboard"
#define USBD_CONFIGURATION_STRING_HS     "USB Keyboard Config"
#define USBD_INTERFACE_STRING_HS     "USB Keyboard Interface"
